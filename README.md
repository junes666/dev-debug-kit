...
| 🌍 **翻译** | **离线中英互译**（ctranslate2 + sentencepiece 神经翻译模型）；自动检测方向；后台推理不卡界面 |
...
| 版本 | 体积 | 说明 |
|------|------|------|
| **精简版** `开发调试-精简版-win64.zip` | ~35 MB | 秒启动。7 个功能全部内置离线；**翻译**首次使用时点「下载翻译组件」自动下载(约180MB)，之后永久离线 |
| **全离线版** `开发调试-全离线版-win64.zip` | ~180 MB | 含离线中英翻译模型，**翻译开箱即用**、全程不联网 |
